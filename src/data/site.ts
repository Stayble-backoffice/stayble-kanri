...
export const pageMeta = {
  home: {
    path: "/",
    title: "今の管理会社、高すぎませんか？｜札幌の乗り換え民泊管理 Stayble",
    description:
      "札幌市中心の開業済み民泊向け「乗り換え民泊管理」。管理費は月額5,000円〜+売上5%。清掃・リネンサプライ・OTA運用・現地対応まで、清掃会社のStaybleがまとめて支えます。小樽・千歳・恵庭・北広島・江別も対応。"
  },
  pricing: {
    path: "/pricing/",
    title: "民泊管理費を見直すなら｜料金表・管理控除後シミュレーション Stayble",
    description:
      "Staybleの乗り換え民泊管理は、管理費が月額5,000円〜+売上5%。清掃費・リネンサプライ費などの費用構造と、既存管理会社から乗り換えた場合の管理控除後シミュレーションを分かりやすく紹介します。"
  },
  switching: {
    path: "/switching/",
    title: "民泊管理会社の乗り換えならStayble｜開業済み民泊向け管理サービス",
    description:
      "既存管理会社の管理費や清掃品質に不満がある民泊オーナーへ。Staybleは初期費用0円、写真撮影0円、OTA初期立ち上げ0円で、開業済み民泊の乗り換え管理をサポートします。"
  },
  services: {
    path: "/services/",
    title: "乗り換え民泊管理のサービス内容｜清掃・OTA・現地対応まで Stayble",
    description:
      "Staybleの乗り換え民泊管理は、清掃・リネンサプライ・OTA運用・宿泊者名簿・現地対応・定期報告まで、開業済み民泊の運用に必要な業務を支援します。申請代行ではなく、運用中物件の管理に特化しています。"
  },
  cleaning: {
    path: "/cleaning-linen/",
    title: "札幌の民泊清掃・リネンサプライ込み管理｜清掃会社が請け負う民泊管理 Stayble",
    description:
      "清掃品質まで責任を持つため、Staybleの乗り換え民泊管理では清掃・リネンサプライをセット契約にしています。民泊清掃管理約240室、年間清掃約15,000件の現場実績をもとに、札幌の民泊運営を支えます。"
  },
  emergency: {
    path: "/emergency/",
    title: "民泊の駆け付け・緊急対応｜札幌の乗り換え民泊管理 Stayble",
    description:
      "Staybleの現地対応は8:00〜22:00を基本に、22時以降は火災・水漏れ・ガス・鍵トラブルなど緊急性の高い事案に限定して対応。固定料金制で、対応後はオーナー様へ報告します。"
  },
  faq: {
    path: "/faq/",
    title: "よくある質問｜乗り換え民泊管理・料金・清掃・OTA・駆け付け Stayble",
    description:
      "Staybleの乗り換え民泊管理に関するよくある質問。料金、清掃・リネンサプライ、OTA立ち上げ、駆け付け対応、宿泊者名簿、対応エリアなど、開業済み民泊オーナー向けに分かりやすく整理しています。"
  },
  contact: {
    path: "/contact/",
    title: "無料相談｜民泊管理会社の乗り換え・管理控除後シミュレーション Stayble",
    description:
      "現在の管理費や月間売上をもとに、Staybleへ乗り換えた場合の管理費・清掃費控除後に残る金額を試算します。札幌市中心の開業済み民泊向け、乗り換え民泊管理の無料相談はこちら。"
  }
};
